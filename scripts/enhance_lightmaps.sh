...
do
	...
	convert -selective-blur 6x6+40% -blur 1x1 -channel RGB -level 0.2%,980%,1.0 ../public/gltf/${obj}_Bake1_PBR_Lightmap.exr -depth 16 -colorspace RGB PNG64:../public/gltf/${obj}_Bake1_PBR_Lightmap_denoise.png
